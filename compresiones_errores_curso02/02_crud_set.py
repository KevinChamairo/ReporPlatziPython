...
#in, permite sabes si un elemento se encuentra en el conjunto, la expresión se evalua 
# como true si el elemento se encuentra en el conjunto y false si el elemento nose encuentra en el conjunto
